...
exports.seedTechnicians = seedTechnicians;
...
async function seedTechnicians() {
    ...
    const existing = await (0, DispatchAgent_js_1.getAllTechnicians)();
    ...
    for (const tech of technicians) {
        try {
            const id = await (0, DispatchAgent_js_1.createTechnician)(tech);
    ...
    // Verify
    const allTechs = await (0, DispatchAgent_js_1.getAllTechnicians)();
...
//# sourceMappingURL=seed-technicians.js.map