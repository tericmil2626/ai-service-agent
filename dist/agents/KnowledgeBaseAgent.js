...
exports.KnowledgeBaseAgent = void 0;
...
class KnowledgeBaseAgent {
    ...
    checkForHandoffTriggers(message) {
    ...
    generateResponse(entry, confidence) {
    ...
    getStructuredOutput(intent, handoffAgent, reason) {
        if (handoffAgent) {
            return {
                intent,
...
exports.KnowledgeBaseAgent = KnowledgeBaseAgent;
exports.default = KnowledgeBaseAgent;
