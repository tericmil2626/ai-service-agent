...
exports.ReceptionistAgent = void 0;
...
class ReceptionistAgent {
    ...
    async generateResponse() {
        ...
        if (!hasServiceType)
            missing.push('what type of service');
        if (!hasPreferredTime)
            missing.push('when you prefer');
...
exports.ReceptionistAgent = ReceptionistAgent;
exports.default = ReceptionistAgent;
